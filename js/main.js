$(document).ready(function(e) {
   ...
   $( '.slider-load').load(function() {
        $('.bx-wrapper').fadeIn(500);
    });
	...
	var ibl1 = 0;
	$('.adv-ul li').each(function(){
        $(this).attr('class','advantages'+ibl1);
		ibl1++;
  	});
	
	$('.our-clients-block p img').each(function(){
        $(this).attr('class','clients-img');
  	});	
